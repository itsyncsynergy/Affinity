          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="x_panel">
                 <div class="x_title">
                 <h2 class="brief"><i>{!! $experience->experience_name !!}</i></h2>
                  ...
                  <div class="x_content">
                    <div class="col-md-12 col-sm-12 col-xs-12 profile_details">
                        <div class="well profile_view">
                          <div class="col-sm-12">
                            {{--  <h4 class="brief"><i>{!! $experience->experience_name !!}</i></h4>  --}}
                            <div class="left col-xs-7">
                              <h4><strong>Name:</strong> {!! $experience->experience_name !!}</h4>
                              <p><strong>Country: </strong> {!! $experience->countryName !!}</p>
                              <p><strong>State: </strong> {!! $experience->state !!}</p>
                              <p><strong>Venue: </strong> {!! $experience->venue !!}</p>
                              <p><strong>Category: </strong> {!! $experience->cate_title !!}</p>
                              <p><strong>Start & End Date: </strong> {!! $experience->experience_start_date !!} & {!! $experience->experience_end_date !!}</p>
                              <div><strong>Details: </strong> {!! $experience->details !!}</div>
                              
                            </div>
                            <div class="right col-xs-5 text-center">
                              <img src="../{{ $experience->avatar}}" alt="" class="img-circle img-responsive">
                            </div>
                          </div>
                          <div class="col-xs-12 bottom text-center">
                            <div class="col-xs-12 col-sm-6 emphasis">
                              <p class="ratings">
                                <a>{!! $experience->curr !!} {!! $experience->price !!}</a>   
                              </p>
                            </div>
                   ...
                   <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                      <div class="panel">
                        <a class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                          <h4 class="panel-title">Experience Gallery</h4>
                        </a>
