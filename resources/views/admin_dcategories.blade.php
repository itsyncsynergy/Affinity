          ...
          <div class="">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                @endif
                <div class="x_panel">
                  <div class="x_title">Donation Categories <small>Lists</small></h2>
            ...
            <div class="row">
              ...
              <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="admin_dcategories_store">
  ...
  <div id="edit_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="admin_dcategories_update">
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-3">Subtitle</label>
            <div class="col-md-9 col-sm-9 col-xs-9">
  ...
  <div id="delete_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="admin_dcategories_delete">
