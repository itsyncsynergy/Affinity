        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-19 col-sm-9 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Luxury Rental & Charters <small>New</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      </li>
                      <li class="dropdown">
                        <a href="admin_rentals"><i class="fa fa-fire"></i> List Luxury Rentals & Charters</a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="admin_rental_store">
