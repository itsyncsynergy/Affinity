  ...
  <head>
    ...
    <script>
      ...
      function openMyModal(data){
        ...
        document.getElementById('body-2').innerHTML = data.feed_type;
          ...
          <div class="">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                @endif
                <div class="x_panel">
                  <div class="x_title">Feeds <small>List</small></h2>
                        ...
                        <tr>
                          <td>
                            <div class="profile_pic">
                              <img src="public/{{ $feed->avatar or 'images/profile.png'}}" style="width:60px !important; height:60px;" alt="..." class="img-circle profile_img">
                            </div>
                          </td>
                          <td>{!! $feed->title !!}</td>
            ...
            <div class="row">
              ...
              <div class="x_panel">
                  <div class="x_title">
                    <h2>Feeds <small>New</small></h2>
                    
                  </div>
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="admin_feed_store">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Feed Type</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <select class="select2_single form-control" name="feed_type" tabindex="-1">
  ...
  <div id="edit_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="admin_feed_update">
          ...
          <input type="hidden" name="feed_id" id="feed_id" class="form-control">
          <div class="ln_solid"></div>
