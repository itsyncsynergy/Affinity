  ...
  <head>
    ...
    <script>
      ...
      function openLink(data){
        location.href = "admin_comment/private_parties/"+data.id;
      }
    </script>  
  </head>
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Private Party <small>Requests</small></h2>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      @foreach ($events as $key => $event) 
                        <tr>
                         ...
                         <td>
                            <form class="form-horizontal form-label-left" id="updateAdmin<?php echo $key; ?>" method="post" enctype="multipart/form-data" action="admin_private_party_update_admin">
                          ...
                          <td>
                            <form class="form-horizontal form-label-left" id="updateStatus<?php echo $key; ?>" method="post" enctype="multipart/form-data" action="admin_private_party_update_status">
