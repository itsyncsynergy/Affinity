  ...
  <body class="nav-md">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Luxury Travel Experience <small>Requests</small></h2>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      @foreach ($requests as $key => $request) 
                        <tr>
                          ...
                          <td>
                            <form class="form-horizontal form-label-left" id="updateStatus<?php echo $key; ?>" method="post" enctype="multipart/form-data" action="admin_luxury_experience_update_status">
    ...
    <script>
      ...
      function openMyModal(data){
        ...
        document.getElementById('body-1').innerHTML = data.experience_name;
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
            <h5><b>Luxury Travel Experience</b></h5>
              <p id="body-1"></p>
              <h5><b>Phone</b></h5>
              <p id="body-2"></p>
              <h5><b>Details</b></h5>
