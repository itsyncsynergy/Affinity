        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-19 col-sm-9 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Private Party <small>Add</small></h2>
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="admin_private_party_store">
