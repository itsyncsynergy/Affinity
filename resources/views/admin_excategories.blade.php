          ...
          <div class="">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                @endif
                <div class="x_panel">
                  <div class="x_title">Experience Categories <small>Lists</small></h2>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <a href="admin_excategories_delete/{!! $category->category_id !!}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                          </td>
                        </tr>
                      @endforeach 
                      </tbody>
            ...
            <div class="row">
              ...
              <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="admin_excategories_store">
