    ...
    <script>
      ...
      function deleteImage(id){
        ...
        $.confirm({
          ...
          buttons: {
              Confirm: function () {
                  location.href="../admin_delete_experience_image/" +id
              },
              cancel: function () {
                  $.alert('Canceled!');
              }
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-7 col-sm-7 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit <small>{!! $experience->name !!}</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      </li>
                      <li class="dropdown">
                        <a href="../admin_experiences"><i class="fa fa-experience"></i> List experiences</a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="../admin_experience_update">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Name</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" name="experience_name" value="{!! $experience->experience_name !!}" class="form-control" required>
                        ...
                        <div class="control-group">
                          ...
                          <label class="control-label col-md-3 col-sm-3 col-xs-3">Start & End Date</label>
                            <div class="input-prepend input-group col-md-9 col-sm-9 col-xs-9">
                              ...
                              <input type="text" name="date" id="reservation-time" class="form-control"  value="{!! $experience->experience_start_date !!} {!! $experience->experience_end_date !!}" />
                            </div>
                          </div>
                        </div>
                      </fieldset> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" name="venue" class="form-control" value="{!! $experience->venue !!}" required>
                          <span class="fa fa-map-marker form-control-feedback right" aria-hidden="true"></span>
                        </div>
                      </div>  
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <textarea type="text" name="details" class="resizable_textarea form-control" required placeholder="Details here..."> {!! $experience->details !!}</textarea>
                        </div>
                      </div>
                      <input type="hidden" name="experience_id" class="form-control" value="{!! $experience->experience_id !!}" required>
              ...
              <div class="col-md-5">
                ...
                <div class="x_panel" style="height: 580px;overflow: auto !important;">
                  ...
                  <div class="x_content">
                    <div class="row">
                      <form id="uploadForm" action="../admin_upload_experience_gallery" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-md-4" style="margin-bottom: 10px;">
                        <!--<a href="../../affinity/public/delete_experience_gallery/{!! $dGallery->id !!}/{!! $dGallery->avatar !!}"><i class="fa fa-trash-alt" style="color: #666;"></i></a>-->
