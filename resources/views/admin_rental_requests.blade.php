  ...
  <body class="nav-md">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Luxury Rentals & Charters <small>Requests</small></h2>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      @foreach ($requests as $key => $request) 
                        <tr>
                          ...
                          <td>
                            <form class="form-horizontal form-label-left" id="updateAdmin<?php echo $key; ?>" method="post" enctype="multipart/form-data" action="admin_rental_update_admin">
                              <select class="select2_single form-control" onchange="updateAdmin({{$key}})"  name="in_charge" tabindex="-1">
                                <option value="{{$request->in_charge}}" disabled selected>{{$request->in_charge}}</option> 
                          ...
                          <td>
                            <form class="form-horizontal form-label-left" id="updateStatus<?php echo $key; ?>" method="post" enctype="multipart/form-data" action="admin_rental_update_status">
    ...
    <script>
      ...
      function openMyModal(data){
        ...
        document.getElementById('body-1').innerHTML = data.name;
        document.getElementById('body-2').innerHTML = data.phone;
        document.getElementById('body-3').innerHTML = data.details; 
      }
    </script>
