                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li class="dropdown">
                        <a href="../admin_groups" style="color: #800020;"><i class="fa fa-group"></i> List Groups</a>
                      </li>
                ...
                <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                      <div class="panel">
                        <a class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                          <h4 class="panel-title">Interest Gallery</h4>
                        </a>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered">
                  ...
                  @foreach ($group_posts as $group) 
                    <tr>
                      <td>
                        <div class="profile_pic">
                          <img src="../{{ $group->avatar or 'images/profile.png'}}" style="width:60px !important; height:60px;" alt="..." class="img-circle profile_img">
                        </div>
                      </td>
                      <td>{!! $group->title !!}</td>
                      <td>{!! $group->post !!}</td>
