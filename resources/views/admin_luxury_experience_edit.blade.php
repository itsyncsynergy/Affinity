                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        <a href="../admin_luxury_experiences"><i class="fa fa-experience"></i> List Luxury experiences</a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="../admin_luxury_experience_update">
                ...
                <div class="x_panel" style="height: 580px;overflow: auto !important;">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        <a href="../admin_luxury_experiences"><i class="fa fa-experience"></i> List experiences</a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <div class="row">
                      <form id="uploadForm" action="../admin_upload_luxury_experience_gallery" method="post" enctype="multipart/form-data">
