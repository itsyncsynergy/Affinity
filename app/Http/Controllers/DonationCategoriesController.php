...
class DonationCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin_dcategories')->with(['user'=> $user, 'categories'=> $categories]);

    }

    public function getDonCat()
    {
        $don_cat = DonationCategories::all();
    ...
    {
       $categories = new DonationCategories;
    ...
    public function update(Request $request)
    {
        ...
        $categories = DonationCategories::where('category_id', $request->input('category_id'))->first();
